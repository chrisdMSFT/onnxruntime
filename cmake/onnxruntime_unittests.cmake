...
if(NOT onnxruntime_ENABLE_TRAINING_TORCH_INTEROP)
  if(NOT IOS)
    ...
    if(onnxruntime_BUILD_SHARED_LIB)
      ...
      # Microsoft.WindowsAppSDK.Foundation.1.8.251104000\include\MddBootstrap.h

      message(STATUS "------------------- ORT_API_MANUAL_INIT -------------------")

      target_compile_definitions(onnx_test_runner_common
        PRIVATE
        ORT_API_MANUAL_INIT
      )
