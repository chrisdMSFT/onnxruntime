@echo off
REM Script to copy standalone_winml_perf_test.exe and .pdb to OneDrive with date-commitish folder pattern
...
set DestBase=C:\Users\chrisd\OneDrive - Microsoft\standalone_winml_perf_test
set DestFolder=!DestBase!\!FolderName!\!Arch!

REM Verify source files exist
set ExePath=!SourceDir!\standalone_winml_perf_test.exe
set PdbPath=!SourceDir!\standalone_winml_perf_test.pdb
...
echo Files copied:
echo   - standalone_winml_perf_test.exe
echo   - standalone_winml_perf_test.pdb
echo.
echo Success!
